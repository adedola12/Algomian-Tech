/* ────────────────────────────────────────────────────────────
   ...
   const user = JSON.parse(localStorage.getItem("algomian:user") || "{}");
   ...
   export default function AddProduct() {
     ...
     const {
       ...
       defaultValues: {
         ...
         quantity: 1, costPrice: "",            /* sellingPrice lives below */
         stockLocation: "", supplier: "",
   
         /* variant-display-section root fields */
     ...
     /* disable manual ID if Autogenerated */
     ...
     const onSubmit = async (data) => {
       ...
       [
         ...
         "storageRam", "Storage",
         "availability", "status", "stockLocation", "productId",
     ...
     return (
       ...
       >
         ...
         <Block {...META[0]} first>
           ...
           <div className="grid gap-6 sm:grid-cols-2">
             ...
             <L label="Product Condition">
               <select {...register("productCondition", { required: true })} className="input">
           ...
           <div className="grid gap-6 sm:grid-cols-2">
             <L label="Brand">
               <select {...register("brand", { required: "Brand required" })} className="input">
                 <option value="" disabled hidden>
                   Select brand
                 </option>
                 <option>Dell</option>
           ...
           {/* row 3 – Base Ram, Base Storage, Base CPU, Serial */}
           <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
             <L label="Base RAM">
               <select {...register("baseRam")} className="input">
                 <option value="" disabled hidden>
                   Select RAM
                 </option>
                 <option>8GB</option>
             ...
             <L label="Base Storage">
               <select {...register("baseStorage")} className="input">
                 <option value="" disabled hidden>
                   Select Storage
                 </option>
                 <option>256GB</option>
             ...
             <L label="Base CPU / Processor">
               <select {...register("baseCPU")} className="input">
                 <option value="" disabled hidden>
                   Select CPU
                 </option>
             ...
             <L label="Serial Number">
               <input {...register("serialNumbers")} placeholder="SN-12345" className="input" />
             </L>
           </div>
   
          
   
           {/* row 4 – cost / stock / supplier */}
           <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
             <L label="Enter Cost Price per Unit">
               <input
         ...
         {/*──────── VARIANTS ────────*/}
         <Block {...META[1]}>
           {/* root fields mapped to storageRam / Storage / sellingPrice */}
           <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
             <L label="Base RAM">
               <select {...register("storageRam")} className="input">
                 <option value="" disabled hidden>
                   Select RAM
                 </option>
                 <option>8GB</option>
             ...
             <L label="Base Storage">
               <select {...register("Storage")} className="input">
                 <option value="" disabled hidden>
                   Select Storage
                 </option>
                 <option>256GB</option>
           ...
           {variantF.map((v, idx) => (
             <div key={v.id} className="mb-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               <L label="Input Cost">
                 <input
                   {...register(`variants.${idx}.inputCost`, { valueAsNumber: true })}
                   className="input"
                   placeholder="0"
                 />
               </L>
         ...
         <Block {...META[2]}>
           ...
           <div className="grid sm:grid-cols-[160px_1fr] md:grid-cols-[180px_1fr] gap-0.5">
             <select {...register("productIdMode")} className="input rounded-r-none">
             ...
             <input
               ...
               placeholder={
                 pidMode === "Autogenerated" ? "Generated automatically" : "Enter product ID"
               }
